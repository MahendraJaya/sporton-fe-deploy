  ...
  return (
    <header>
      <div className="container flex justify-between gap-10 mx-auto py-7 items-center">
        <Image src="/images/logo.svg" alt="logo" width={127} height={30} onClick={() => push("/")} className="cursor-pointer" />
        <nav className="flex gap-44 font-medium">
          <Link href="/" className="relative after:content-[''] after:block after:bg-primary after:rounded-full after:h-[3px] after:w-1/2 after:left-1/2 after:-translate-x-1/2 after:w-full after:absolute">Home</Link>
