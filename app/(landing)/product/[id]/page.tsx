...
import { getDetailProduct } from "@/app/services/product.service";
...
const ProductDetail = async({params} : TPageParams) => {
  ...
  return (
    <main className="container mx-auto py-40 flex gap-12">
      ...
      <div className="w-full py-7">
        ...
        <div className="bg-primary-light rounded-full py-2 px-6 text-primary w-fit">{product.category.name}</div>
